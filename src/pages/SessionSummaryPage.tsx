...
export function SessionSummaryPage() {
  ...
  const therapist =
    therapistData[state?.therapistId as keyof typeof therapistData] ||
    therapistData["1"];
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold gradient-text">
                  {formatTime(state?.duration || 1800)}
                </div>
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
              Today's session focused on identifying and managing stress
              triggers in your daily life. We explored several coping strategies
              and discussed how to implement healthy boundaries both at work and
              in personal relationships. You showed great insight into your
              thought patterns and demonstrated openness to trying new
              approaches.
            </p>
            <div className="text-sm text-slate-600 dark:text-slate-400 italic">
              "Remember, healing is not linear. Every step forward, no matter
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p className="text-slate-600 dark:text-slate-400 mb-4 text-sm">
              Here are some strategies to practice between now and your next
              session:
            </p>
            <div className="grid gap-3">
              {actionPlan.map((action, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-mint-50 to-teal-50 dark:from-mint-900/20 dark:to-teal-900/20"
                >
        ...
        <div className="text-center mt-8">
          <Card className="bg-gradient-to-r from-lavender-50 to-sky-50 dark:from-lavender-900/20 dark:to-sky-900/20">
            <CardContent className="p-6">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Remember to be patient and kind with yourself as you continue
                this journey. Progress takes time, and you're exactly where you
                need to be.
              </p>
            </CardContent>
          </Card>
